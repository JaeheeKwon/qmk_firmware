...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_69(
     ...
     // KC_LCTL, KC_LOPT,  KC_LCMD,           KC_SPC,           MO(_FN1), MO(_FN3),         KC_SPC,            KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT),
        KC_LCTL, KC_LOPT,  KC_LCMD,           KC_SPC,           MO(_FN3), KC_SPC,         KC_SPC,            KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
     ...
     // KC_LCTL, KC_LWIN,  KC_LALT,           KC_SPC,           MO(_FN2), MO(_FN3),         KC_SPC,            KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT),
        KC_LCTL, KC_LWIN,  KC_LALT,           KC_SPC,           MO(_FN3), KC_SPC,           KC_SPC,            KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN3] = LAYOUT_ansi_69(
        KC_TILD, KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   _______,          KC_PRINT_SCREEN,
